...
{
  "$end", "error", "$undefined", "STRING", "MAX_PIXEL", "VAR", "IGUAL",
  "EOL", "ASPA", "MULT", "Operacao", "SOMA", "$accept", "PROGRAMA",
  "EXPRESSAO", "OPERA_PIXEL", "PIXEL_MAXIMO", YY_NULLPTR
};
#endif
...
#line 35 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
    	...
    	if(params.type == 1){
	        ...
	        printf("Copia sequential\n");
	       	imagem I = abrir_imagem((yyvsp[0].strval), 1.0);
			// printf("Li imagem %d por %d\n", I.width, I.height);
	        salvar_imagem((yyvsp[-2].strval), &I);
	    }else if (params.type == 2){
	    	 // printf("Caso 1: Copiando %s para %s\n", $3, $1);
	        printf("Copia com Threads\n");
	       	imagem I = abrir_imagem_threads((yyvsp[0].strval), 1.0);
			// printf("Li imagem %d por %d\n", I.width, I.height);
	        salvar_imagem_threads((yyvsp[-2].strval), &I);
...
#line 57 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
		...
		if(params.type == 1){
		    ...
		    imagem I = abrir_imagem((yyvsp[-1].strval), (yyvsp[0].fval));
			printf("Li imagem %d por %d\n", I.width, I.height);
...
#line 79 "./src/imageprocessing.y" /* yacc.c:1646  */
	...
	int *indice = pixel_max ((yyvsp[0].strval), posicao);
...
#line 101 "./src/imageprocessing.y" /* yacc.c:1906  */
